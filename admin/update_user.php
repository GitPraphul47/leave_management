...
$select = "SELECT * FROM `user_data` WHERE `id`='$id'";
    ...
    if(isset($_POST['submit'])){
        ...
        $update = "UPDATE `user_data` SET `fname`='$my_fname', `lname`='$my_lname', `username`='$my_user_name',  `email` = '$my_email', `phone` = '$my_phone', `birthday` = '$my_birthday', `image`='$my_image', `gender` = '$my_gender', `education` = '$my_education', `city` = '$my_city', `district` = '$my_district', `pincode`='$my_pincode' WHERE `id`= '$id'";
