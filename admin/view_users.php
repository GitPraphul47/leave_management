            ...
            <tbody>
                ...
                <tr class="">
                    ...
                    $s=1;
                        if(isset($_POST['search_user'])){
                            ...
                            $select = "SELECT * FROM `user_data` WHERE `id` LIKE '%$search_id%' OR `fname` LIKE '%$search_fname%' OR `lname`LIKE'%$search_lname%' OR `phone` LIKE '%$search_phone%'";
                ...
                <tr>
                   ...
                   if(isset($_GET['page'])){
                    ...
                    $select = "SELECT * FROM `user_data` LIMIT {$offset},{$content_limit}" ;
                    $run = mysqli_query($conn, $select);
                    while($data = mysqli_fetch_array($run)){
                        $id = $data['id'];
                        $image = $data['image'];
                    ...
                    <td>
                        <button class="btn btn-success">
                            <a href="update_user.php?id=<?php echo $id ?>" class="text-decoration-none text-light fa fa-edit" title="edit"></a>
                        </button> <br/>
                        <button class="btn btn-danger mt-2 text-light">
                            <a href="delete_user.php?id=<?php echo $id ?>" class="text-decoration-none  fa fa-trash-o fs-4 text-light " title="delete user" > </a>
                        </button>
                    </td>
                    ...
                    <td colspan="10">
                        <?php 
                            ...
                            <?php
                                ...
                                if($page>=2){   
                                    echo '<li class="page-item"><a href="view_users.php?page='.($page-1).'" class="page-link">  Prev </a> </li>';   
                                } 
                                for($i = 1; $i<= $total_pages; $i++) { echo '<li class="page-item"><a href="view_users.php?page='.$i.'" class="page-link">'.$i.' </a> </li>';  
                                } 

                                if( $total_pages > $page ){   
                                    echo '<li class="page-item"><a href="view_users.php?page='.($page+1).'" class="page-link">Next</a> </li>';   
                                }  
