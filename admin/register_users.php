    ...
    if ($password == $c_password){
        ...
        if($fname!="" && $lname!="" && $user_name!="" && $email!="" && $phone!="" && $birthday!="" && $image!="" && $gender!="" && $education!="" && $city!="" && $district!="" && $pincode!="" && $password!=""){
            ...
            if(mysqli_num_rows($run)>0){
                ...
                $insert = "INSERT INTO `user_data`(`fname`, `lname`, `username`, `email`, `phone`, `birthday`, `image`, `gender`, `education`, `city`, `district`, `pincode`, `password`) VALUES ('$fname', '$lname', '$user_name', '$email', '$phone', '$birthday', '$image', '$gender', '$education', '$city', '$district', '$pincode', '$password')";
