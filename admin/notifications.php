            ...
            <tbody>
                <tr>
                   ...
                   if(isset($_GET['page'])){
                    ...
                    $select = "SELECT * FROM `leave_table` WHERE `status`='' LIMIT {$offset},{$content_limit}" ;
                    ...
                    <td colspan="10">
                        <?php 
                            ...
                            <?php
                                ...
                                if($page>=2){   
                                    echo '<li class="page-item"><a href="notifications.php?page='.($page-1).'" class="page-link">  Prev </a> </li>';   
                                } 
                                for($i = 1; $i<= $total_pages; $i++) { echo '<li class="page-item"><a href="notications.php?page='.$i.'" class="page-link">'.$i.' </a> </li>';  
                                } 

                                if( $total_pages > $page ){   
                                    echo '<li class="page-item"><a href="notifications.php?page='.($page+1).'" class="page-link">Next</a> </li>';   
                                }  
