...
<div class="offcanvas offcanvas-start w-25" data-bs-backdrop="static" tabindex="-1" id="staticBackdrop" aria-labelledby="staticBackdropLabel">
  <div class="offcanvas-header navbar_side">
    <a href="index.php" class="logo offcanvas-title d-flex text-align-center text-decoration-none w-75 h-50" id="staticBackdropLabel ">
        ...
        <div class=" fs-2 fw-bolder text-light w-75"> Admin Panel</div>
    </a>
    ...
    <div class=" bg-secondary p-3 h-100 ">
        <ul class="list-group list-group-flush bg-secondary">
            ...
            <li class="list-group-item bg-secondary text-light">
                <a href="update_profile.php" class="bg-secondary text-light text-decoration-none fs-3"> <i class="fa fa-address-book-o"></i>  Update Profile</a>
            </li>
            <li class="list-group-item bg-secondary text-light">
                <a href="leave_apply.php" class="bg-secondary text-light text-decoration-none fs-3"> <i class="fa fa-address-card-o"></i>  Apply For Leave</a>
            </li>
            <li class="list-group-item bg-secondary text-light">
                <a href="application_status.php" class="bg-secondary text-light text-decoration-none fs-3"> <i class="fa fa-group"></i>  Application Status</a>
            </li>
            <!-- <li class="list-group-item bg-secondary text-light">
                <a href="" class="bg-secondary text-light text-decoration-none fs-3"> <i class="fa fa-home"></i>  Home</a>
            </li> -->
        </ul>
        <!-- footer of side bar  -->
        <div class="position-absolute bottom-0  m-3">
            <a href="user_log_out.php" class="text-decoration-none m-2 text-light">Log Out</a>
